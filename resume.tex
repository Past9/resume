...
\begin{document}
    ...
    Technical skills include JavaScript, .NET (C\#, Web API), SQL Server, MySQL, HTML5, CSS3, Bootstrap 3, AngularJS, jQuery, PHP5, Rust, REST APIs, Event Sourcing, CQRS, Domain Driven Design, Object-oriented design, VIM, Visual Studio, Linux (Ubuntu), Windows.
